...
chunk_sizes=(1024 2048 4096 8192)  # Distintos tamaños de chunk
results_file="resultados_local.txt"
...
python3 create_files.py $test_file 52428800 # 50 MB para localhost
